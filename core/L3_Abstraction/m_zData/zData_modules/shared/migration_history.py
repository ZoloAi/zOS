# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/migration_history.py
"""
...
Ensure migrations table exists:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.migration_history import ensure_migrations_table
    >>> ensure_migrations_table(adapter)

Record successful migration:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.migration_history import record_migration
    >>> metrics = {
...
Check if migration already applied:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.migration_history import is_migration_applied
    >>> schema_hash = get_current_schema_hash(schema_dict)
    >>> if is_migration_applied(adapter, schema_hash):
    ...     print("Migration already applied - skipping")

Get migration history:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.migration_history import get_migration_history
...
import hashlib
from zOS import time, datetime, Dict, List, Any
