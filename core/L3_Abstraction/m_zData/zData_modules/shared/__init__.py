# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/__init__.py
"""
...
**Validator (1 class):**
- **DataValidator(schema, zos)**: 5-layer validation architecture

**Facade (1 class):**
- **DataOperations(zos, schema, adapter)**: Central operation router
...
-------------
Using parsers:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared import parse_where_clause, parse_value
...
Using DataOperations facade:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared import DataOperations
    >>> ops = DataOperations(zos, schema, adapter)
