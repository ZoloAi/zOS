# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/backends/adapter_factory.py
"""
...
class AdapterFactory:
    ...
    **4. Error Handling:**
    ...
    def set_logger(cls, logger: Any) -> None:
        ...
        """
        cls._logger = logger
        # Logger set - no need to log this internal detail
    ...
    def create_adapter(cls, data_type: str, config: Dict[str, Any]) -> Any:
        ...
        if cls._logger:
            # Log at DEBUG level - schema_manager provides INFO summary
            cls._logger.debug(f"Created {adapter.__class__.__name__} adapter for data type: {data_type}")
        return adapter
