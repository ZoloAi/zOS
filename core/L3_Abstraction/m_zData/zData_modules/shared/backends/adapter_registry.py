# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/backends/adapter_registry.py
"""
...
Plugins can register custom adapters using `register_custom_adapter()`:
    ...
    from zOS.L3_Abstraction.m_zData.zData_modules.shared.backends.adapter_registry import register_custom_adapter
...
Built-in adapters (auto-registered):
    ...
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.backends import adapter_registry
    >>> # Adapters now available via AdapterFactory.create_adapter()
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.backends.adapter_factory import AdapterFactory
...
logger = logging.getLogger("zOS.zData")
...
def register_custom_adapter(data_type: str, adapter_class: Any) -> None:
    ...
    Example:
        >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.backends.base_adapter import BaseDataAdapter
        >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.backends.adapter_registry import (
