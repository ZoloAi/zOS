# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/operations/__init__.py
"""
...
6. **Display Results**: Mode-aware output via zDisplay (zCLI vs Bifrost)
...
INSERT operation:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.operations import handle_insert
...
READ operation with pagination:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.operations import handle_read
    >>> request = {"table": "users", "where": "age >= 18", "limit": 20, "offset": 40}
    >>> result = handle_read(ops, request, display)

DROP TABLE with safety:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.operations import handle_drop
...
from .crud_truncate import handle_truncate
from .agg_aggregate import handle_aggregate
from .agg_window import handle_window
from .agg_set import handle_set
