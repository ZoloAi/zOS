# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/parsers/__init__.py
"""
...
WHERE clause parsing:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.parsers import parse_where_clause
...
Value type parsing:
    >>> from zOS.L3_Abstraction.m_zData.zData_modules.shared.parsers import parse_value
    >>> parse_value("42")
    42
    >>> parse_value("true")
    True
