# zOS/core/L3_Abstraction/m_zData/zData_modules/shared/parsers/value_parser.py
"""
...
# "1" and "0" are intentionally excluded so that numeric WHERE clauses like
# "id = 1" parse to integer 1, not boolean True. Only word-form booleans
# are accepted here.
_BOOL_TRUE_VALUES = ("true", "yes")

# False boolean literals (case-insensitive comparison)
_BOOL_FALSE_VALUES = ("false", "no")
...
def parse_value(value_str: str) -> Union[int, float, bool, str, None]:
    ...
    Type Detection Details:
        **Boolean Detection** (Highest Priority):
            ...
            - "no", "NO", "No" → False
            Note: "1" and "0" are NOT treated as booleans; they parse as int 1/0.
    ...
    Notes:
        ...
        - Boolean detection takes precedence over numeric for word-form literals only
