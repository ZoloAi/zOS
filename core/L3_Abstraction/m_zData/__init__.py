# zOS/core/L3_Abstraction/m_zData/__init__.py
"""
...
- Interactive pagination in zCLI mode (press Enter to continue)
...
**zSession**: Active session state, zMode detection (zCLI, Walker, zBifrost)
