...
- macOS:   ~/Library/Application Support/zOS/users/{user_id}/
- Linux:   ~/.local/share/zOS/users/{user_id}/
- Windows: %LOCALAPPDATA%\\zOS\\users\\{user_id}\\
"""

from zOS import os, Dict, Any
...
class StoragePathManager:
    ...
    def get_user_storage_path(self, user_id: int) -> str:
        ...
        Returns:
            str: Path like ~/Library/Application Support/zOS/users/123/
        """
