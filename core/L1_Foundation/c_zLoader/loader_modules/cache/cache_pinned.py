# zOS/core/L1_Foundation/c_zLoader/loader_modules/cache/cache_pinned.py
...
**Used By**:
    ...
    - User Commands:
      - `load --as myalias path/to/schema.zolo` → load_alias()
...
**Load Alias**:
    ...
    >>> cache.load_alias("users_db", parsed_schema, "~/db/users.zolo")
...
**Get Alias Info**:
    ...
    >>> print(info)
    {'name': 'users_db', 'zpath': '~/db/users.zolo', 'type': 'schema',
...
from zOS.L1_Foundation.a_zConfig.zConfig_modules import SESSION_KEY_ZCACHE, ZCACHE_KEY_PINNED
