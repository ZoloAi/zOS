# zOS/core/L1_Foundation/b_zComm/zComm_modules/services/postgresql_service.py
"""
PostgreSQL Service Manager for zOS.
...
from zOS import subprocess, platform, Path, Any, Dict, Optional, List
...
class PostgreSQLService:
    ...
    def __init__(self, logger: Any) -> None:
        ...
        self._net = NetworkUtils(logger)  # SSOT port probe
    ...
    def is_running(self, port: Optional[int] = None) -> bool:
        ...
        # Delegate the TCP probe to the zComm SSOT (NetworkUtils)
        return self._net.is_port_open(check_port, POSTGRESQL_DEFAULT_HOST)
    ...
    def get_connection_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            CONN_KEY_CONNECTION_STRING: (
                f"postgresql://{POSTGRESQL_DEFAULT_USER}@{POSTGRESQL_DEFAULT_HOST}:"
                f"{POSTGRESQL_DEFAULT_PORT}/{POSTGRESQL_DEFAULT_DATABASE}"
            )
        }
