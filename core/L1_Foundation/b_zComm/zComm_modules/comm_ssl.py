# zOS/core/L1_Foundation/b_zComm/zComm_modules/comm_ssl.py
"""
...
from zOS import ssl, Path, Optional, Any
...
def create_ssl_context(
    ...
    This is the canonical SSL context creation function for all zOS servers
