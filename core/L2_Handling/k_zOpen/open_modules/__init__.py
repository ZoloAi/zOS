# zOS/core/L2_Handling/k_zOpen/open_modules/__init__.py
...
Usage Example:
    ...
    from zOS.L2_Handling.k_zOpen.open_modules import resolve_zpath, open_url, open_file

    # Or import from specific modules (also valid)
    from zOS.L2_Handling.k_zOpen.open_modules.open_paths import resolve_zpath
    from zOS.L2_Handling.k_zOpen.open_modules.open_urls import open_url
...
Design Pattern:
    ...
    - zOS.subsystems.zLoader.loader_modules
    - zOS.subsystems.zFunc.zFunc_modules
    - zOS.subsystems.zDialog.dialog_modules
