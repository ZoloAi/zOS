# zOS/core/L2_Handling/k_zOpen/open_modules/open_urls.py
...
from zOS import subprocess, webbrowser, urlparse, Any
...
from zOS.L1_Foundation.a_zConfig.zConfig_modules.machine.detectors import get_browser_launch_command
