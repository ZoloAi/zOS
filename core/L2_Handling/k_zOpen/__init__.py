...
Integration with zOS:
    Initialized in zOS.__init__() (line ~210):
        from zOS.L2_Handling.k_zOpen import zOpen
...
Usage Example:
    ...
    result = zos.open.handle("zOpen(/path/to/file.txt)")

    # From custom code (direct usage)
    from zOS.subsystems.zOpen import zOpen
