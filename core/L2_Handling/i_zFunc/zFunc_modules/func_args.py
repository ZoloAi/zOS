# zOS/core/L2_Handling/i_zFunc/zFunc_modules/func_args.py
...
# Import shared constants from func_constants (centralized SSOT)
...
def parse_arguments(
    ...
    try:
        ...
        split_result: List[str] = split_fn(arg_str)
        args_raw = [arg.strip() for arg in split_result]
...
# NOTE: split_arguments() is now imported from arg_processing.argument_splitter
# which delegates to zParser's universal splitter (SSOT)
# See: zOS.L2_Handling.d_zParser.parser_modules.shared.argument_utils
