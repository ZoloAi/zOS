# zOS/core/L2_Core/g_zParser/parser_modules/vafile/__init__.py
...
# Root SSOT for the raw zVaFile subtype ids. Import-ALIASED to avoid colliding
# with this package's lowercase normalized labels below (FILE_TYPE_UI = "ui", a
# DIFFERENT concept from the raw subtype id "zUI").
from zOS.zVocabulary import (
    FILE_TYPE_UI as _VOCAB_FILE_TYPE_UI,
    FILE_TYPE_SCHEMA as _VOCAB_FILE_TYPE_SCHEMA,
    FILE_TYPE_CONFIG as _VOCAB_FILE_TYPE_CONFIG,
)
...
# File Types — raw zVaFile subtype ids, aliased to the root vocabulary (SSOT)
FILE_TYPE_ZUI: str = _VOCAB_FILE_TYPE_UI
FILE_TYPE_ZSCHEMA: str = _VOCAB_FILE_TYPE_SCHEMA
FILE_TYPE_ZCONFIG: str = _VOCAB_FILE_TYPE_CONFIG
# Normalized internal labels — DISTINCT concept from the raw subtype ids above
FILE_TYPE_UI: str = "ui"
...
def parse_zva_file(
    ...
    """
    if display:
        display.zDeclare("parse_zva_file", color="CONFIG", indent=6, style="single")
