# zOS/core/L2_Core/g_zParser/parser_modules/vafile/vafile_generic.py
...
from . import (
    ...
    FILE_TYPE_ZUI, FILE_TYPE_ZSCHEMA, FILE_TYPE_UNKNOWN,
    DICT_KEY_TYPE, DICT_KEY_FILE_PATH, DICT_KEY_DATA, DICT_KEY_METADATA_KEY,
    LOG_MSG_PARSING_GENERIC, LOG_MSG_EXTRACTING_METADATA,
    ...
    CHAR_EQUALS, CHAR_EXCLAMATION, CHAR_QUESTION
)
    ...
    for key, value in data.items():
        ...
        if isinstance(value, dict):
            ...
            for _field_name, field_data in value.items():
                ...
                current_count = metadata[METADATA_KEY_FIELD_TYPES].get(field_type, 0)
                metadata[METADATA_KEY_FIELD_TYPES][field_type] = current_count + 1
