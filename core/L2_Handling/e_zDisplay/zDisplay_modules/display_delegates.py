# zOS/core/L2_Core/c_zDisplay/zDisplay_modules/display_delegates.py

"""
Primary User-Facing API for zDisplay - Modular Composition.

This module provides the main interface for all display operations in the zOS framework.
...
Layer 1 Position:
    ...
    Integration (zOS.__init__ line 68-69):
...
Terminal vs zBifrost:
    ...
    - display_primitives.py: is_bifrost_mode() checks self._is_bifrost flag
...
Industry-Grade Refactoring (Week 6.4.1):
    ...
    - Clarified architectural role and zOS integration
