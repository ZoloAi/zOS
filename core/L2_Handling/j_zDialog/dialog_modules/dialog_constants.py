# zOS/core/L2_Handling/j_zDialog/dialog_modules/dialog_constants.py
...
# ============================================================================
# SESSION KEYS  →  protocol mode value aliased from root zVocabulary (SSOT)
# ============================================================================

from zOS.zVocabulary import ZMODE_ZBIFROST

_SESSION_VALUE_ZBIFROST: str = ZMODE_ZBIFROST
...
KEY_ZRESET: str = "zReset"   # bool flag → offer a Reset control (restart the form loop)
KEY_WEBSOCKET_DATA: str = "websocket_data"
KEY_DATA: str = "data"
KEY_ZCONV: str = "zConv"
KEY_ZCRUD: str = "zCRUD"
KEY_ZDATA: str = "zData"
KEY_DIALOG_MODE: str = "dialog_mode"

# ============================================================================
# DIALOG MODES
# ============================================================================

DIALOG_MODE_CONFIRM: str = "confirm"   # fields: [] → confirm button / y-n prompt


# ============================================================================
# DIALOG CONTROLS  (zCLI submit / reset chooser — terminal truth of form controls)
# ============================================================================

_CONTROL_SUBMIT: str = "submit"   # commit zConv (run onSubmit) and proceed
_CONTROL_RESET: str = "reset"     # discard zConv and re-run field collection
_LABEL_SUBMIT: str = "Submit"
_LABEL_RESET: str = "Reset"
# Truthy spellings for `zReset: true` (string-first .zolo may keep it as a string)
_TRUTHY: tuple = ("true", "yes", "1", "on")
...
_LOG_DIALOG_RESET: str = "[zDialog] reset — discarding zConv, re-running field collection"


# ============================================================================
# MESSAGES - DIALOG CONTROLS
# ============================================================================

_MSG_DIALOG_CONTROLS: str = "  {controls}   (Enter = Submit): "
