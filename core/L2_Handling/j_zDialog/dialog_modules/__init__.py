# zOS/core/L2_Handling/j_zDialog/dialog_modules/__init__.py
...
Example 2: Direct submission handling
    >>> from zOS.L2_Handling.j_zDialog.dialog_modules import handle_submit
...
__all__ = [
    ...
    "coerce_submit_result",     # onSubmit outcome → ONE ZResult (SSOT — shared with Bifrost)
    "render_submit_signal",     # zCLI: render a submit ZResult as one signal
]
