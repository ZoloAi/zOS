# zOS/core/L2_Handling/j_zDialog/dialog_modules/dialog_context.py
...
def create_dialog_context(
    ...
    Dict[str, Any]
        ...
        {
            "_dialogId": str,          # Unique form identifier (UUID)
    ...
    """
    context = {
        "_dialogId": str(uuid.uuid4()),  # Generate unique ID for each form
        KEY_MODEL: model,
        KEY_FIELDS: fields,
    }
