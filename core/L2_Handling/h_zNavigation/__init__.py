# zOS/core/L2_Handling/h_zNavigation/__init__.py

"""
zNavigation - Unified Navigation System Subsystem.

This package provides comprehensive navigation functionality for zOS,
...
- **Menu Creation**: Interactive menus with zCLI/Bifrost support
