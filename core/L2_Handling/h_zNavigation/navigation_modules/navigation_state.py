# zOS/core/L2_Handling/h_zNavigation/navigation_modules/navigation_state.py
...
from .handlers.handler_history import HistoryManager
...
class Navigation:
    ...
    history_manager: HistoryManager  # History manager component
    ...
    def __init__(self, navigation: Any) -> None:
        ...
        # Initialize history manager (extracted handler)
        self.history_manager = HistoryManager(self.zos, self.logger)
    ...
    def navigate_to(
        ...
        if current:
            self.history_manager.add_to_history(current)
    ...
    def get_current_location(self) -> Dict[str, Any]:
        ...
        """
        return self.zos.session.get(SESSION_KEY_CURRENT_LOCATION, {})
    ...
    def _set_current_location(
        ...
        self.zos.session[SESSION_KEY_CURRENT_LOCATION] = location
