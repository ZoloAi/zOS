# zOS/core/L2_Handling/h_zNavigation/navigation_modules/navigation_menu_builder.py
...
- Used by: Navigation menu creation throughout zOS
...
from zOS import time, Any, Optional, Dict, List, Union, Callable
...
class MenuBuilder:
    ...
    def __init__(self, menu: Any) -> None:
        ...
        Notes
        -----
        The MenuBuilder stores references to the parent menu system, zos instance,
    ...
    def build_from_function(
        ...
        **kwargs : Any
        ...
        try:
            ...
            result = self.zos.zfunc.handle(f"zFunc({func_name}, {args}, {kwargs})")
