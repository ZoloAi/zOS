# zOS/core/L2_Handling/h_zNavigation/navigation_modules/__init__.py
...
5. **MenuRenderer** (navigation_menu_renderer.py)
   - Mode-agnostic menu rendering (zCLI/Bifrost)
...
provides a clean, consistent public API:
    ...
    # Recommended: Use facade (from zOS.py)
...
Direct component usage is supported but not recommended for most use cases:
    ...
    from zOS.L2_Handling.h_zNavigation.navigation_modules import MenuSystem
...
Direct Component Usage (Advanced)::
    ...
    from zOS.L2_Handling.h_zNavigation.navigation_modules import (
...
from .menu.navigation_menu_system import MenuSystem
