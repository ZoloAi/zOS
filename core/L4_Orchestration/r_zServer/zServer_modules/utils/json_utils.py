# zOS/core/L4_Orchestration/r_zServer/zServer_modules/utils/json_utils.py
...
Philosophy:
    "APIs are data, not code" - Define JSON responses in zVaFile

Architecture:
    - Parse zVaFile data definitions
...
from zOS import json, Any, Dict, datetime
import math
                ...
                try:
                    ...
                    if hasattr(zcli, 'navigation'):
                        ...
                        if zVaFile and zVaFolder:
                            # Construct zPath via the routing SSOT builder (leaf-backed).
