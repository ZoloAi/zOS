# zOS/core/L4_Orchestration/r_zServer/__init__.py
...
- Production: Waitress WSGI server (in-process, cross-platform)

Features:
- Declarative routing via zServer type zVaFiles
...
Layer: 4 (Orchestration Subsystem)
...
SUBSYSTEM_LAYER = 4  # Orchestration subsystem
SUBSYSTEM_VERSION = "1.6.6"
