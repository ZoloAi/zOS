<!-- cursor: description="zProgress — a labelled bar or spinner: current/total → determinate bar, no total → spinner; can live-climb inside a zWizard. Reach for showing how-far-along" alwaysApply=false -->
