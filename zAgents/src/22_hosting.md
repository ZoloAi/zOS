<!-- cursor: description="Hosting — zOS control plane above zServer: a ComputeDriver (wake/sleep/status) runs a fleet, scale-from-zero, blue-green deploy. Reach for multi-app or deployment platform work" globs="**/zServer.*.zolo,**/drivers.py,**/plugins/**/*.py" alwaysApply=false -->
