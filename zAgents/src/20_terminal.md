<!-- cursor: description="zTerminal — a code sample with Copy and (when ZTERMINAL_MODE allows) inline Run + streamed output. Reach for showing runnable or copyable code" alwaysApply=false -->
