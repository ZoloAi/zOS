<!-- cursor: description="zControls — zBtn / zSelect / zCheckbox: press, pick, tick (a control takes the action; a container acts on it)" globs="**/zUI.*.zolo" alwaysApply=false -->
