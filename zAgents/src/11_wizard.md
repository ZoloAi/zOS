<!-- cursor: description="zWizard — multi-step flow: named steps run in order, zHat reads prior answers, zGate:/menu/gate steer the walk. Reach for when a later step depends on an earlier answer (a flat set of fields is a zDialog)" alwaysApply=false -->
