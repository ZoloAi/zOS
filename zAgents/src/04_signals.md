<!-- cursor: description="zSignals — status feedback: zSuccess/zError/zWarning/zInfo (+zSignal longhand, flush toast). Reach for when reporting an outcome" alwaysApply=false -->
