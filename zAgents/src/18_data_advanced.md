<!-- cursor: description="zData advanced — beyond CRUD: deep queries (joins, aggregates, window fns, CTEs, full-text), rich writes (RETURNING, upsert, soft delete), bulk, transactions, backends. Still declared, never raw SQL" globs="**/zSchema.*.zolo,**/models/*.zolo" alwaysApply=false -->
