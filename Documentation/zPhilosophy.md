**[Home](../README.md) | [Next: zInstall Guide →](Setup/zInstall_GUIDE.md)**
...
- **Haven't installed zOS yet?**  
  → **[Go to zInstall Guide](Setup/zInstall_GUIDE.md)** — Get set up first.

- **Already installed zOS?** (e.g., from the README)  
  → **[Start with zConfig](L1_Foundation/zConfig_GUIDE.md)** — The **cornerstone of Layer 0 and zOS as a whole**.
